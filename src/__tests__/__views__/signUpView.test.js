...
import { mapStateToProps, mapDispatchToProps } from '../../views/SignUp';
...
describe('SignUp Dispatcher', () => {
  ...
  it('should test onSignUP()', () => {
    const { enzymeWrapperSignUp, props } = setUp();
    enzymeWrapperSignUp.find('#register-form').simulate('submit', {
      preventDefault: () => {}
    });
  ...
  it('should test mapStateToProps', () => {
    ...
    expect(mapStateToProps(testInitialState).user.lastName).toEqual(
      'NIYOMWUNGERI'
    );
  });
});
