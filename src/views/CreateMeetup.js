...
export const CreateMeetup = props => {
  ...
  const handleAddTag = e => {
    ...
    onClearInput({ field: 'newTag', value: '' });
  };
    ...
    <div>
      <React.Fragment>
        ...
        <Container maxWidth="sm">
          ...
          <p>
            Name your meet-up and tell meet-up-goers why they should come. Add
          ...
          <form id="submit-form" onSubmit={handleSubmit}>
            ...
            <FormControl variant="outlined" className={classes.formControl}>
              ...
              >
                <option value=""></option>
                <option value="APPEARANCE_OR_SIGNING">
                  Appearance or Signing
                </option>
                <option value="ATTRACTION">Attraction</option>
                <option value="CAMP_TRIP_RETREAT">
                  Camp, Trip, or Retreat
                </option>
                <option value="CLASS_TRAINING_WORKSHOP">
                  Class, Training, or Workshop
                </option>
                <option value="CONCERT_OR_PERFORMANCE">
                ...
                <option value="MEETING_OR_NETWORKING_EVENT">
                  Meeting or Networking Event
                </option>
                <option value="PARTY_OR_SOCIAL_GATHERING">
                  Party or Social Gathering
                </option>
                <option value="RACE_OR_ENDURANCE_EVENT">
                ...
                <option value="TRADESHOW_CONSUMERSHOW_EXPO">
            ...
            <h1>Location</h1>
            <p>
              Help people in the area discover your meet-up and let attendees
            ...
            <h1>Date and time</h1>
            <p>
              Tell meet-up-goers when your meet-up starts and ends so they can
              ...
              <Grid container spacing={3}>
                <Grid item xs={6}>
                  <DateTimePicker
                    ...
                    value={start_date}
                    onChange={e =>
                      handleDateInputChange({ name: 'start_date', value: e })
                    }
                  />
                ...
                <Grid item xs={6}>
                  <DateTimePicker
                    ...
                    value={end_date}
                    onChange={e =>
                      handleDateInputChange({ name: 'end_date', value: e })
                    }
                  />
...
export const mapDispatchToProps = dispatch => ({
  ...
  onCreateMeetUp: (payload, token) =>
    dispatch(handleCreateMeetUp(payload, token)),
